...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            self.epsilon = math.exp(-0.015*(self.t - 1))
    ...
    def choose_action(self, state):
        ...
        if self.learning == True:
            ...
            if rnd < self.epsilon:
                ...
                max_actions = [k for k, v in self.Q[state].items() if v  == mQ]
...
def run():
    ...
    #    * alpha   - continuous value for the learning rate, default is 0.5 (.01)
    agent = env.create_agent(LearningAgent, learning = True, epsilon=1.0, alpha=.01)
    ...
    # Run the simulator
    # Flags:
    #   tolerance  - epsilon tolerance before beginning testing, default is 0.05  .001
